...
window.__i18nDict("en", {
  ...
  t: {
    "Рабочий ритм": "Work rhythm",
    "Рабочий ритм и аналитика": "Work rhythm and analytics",
    "за всё время": "all time",
    "нет завершений": "no completions",
    "Движение сегодня": "Movement today",
    "Движение": "Activity",
    "Открыть шагомер, пульс и местоположение": "Open step counter, heart rate and location",
    "Скрыть шагомер, пульс и местоположение": "Hide step counter, heart rate and location",
    "Готово к прогулке": "Ready for a walk",
    ...
    "Шагомер остановлен": "Step counter stopped",
    "Шагомер недоступен на этом устройстве": "Step counter is unavailable on this device",
    "Датчик движения не разрешён": "Motion sensor permission was not granted",
    "Не удалось включить датчик движения": "Could not enable the motion sensor",
    "Карты городов": "City maps",
    "Пульс: нет данных": "Heart rate: no data",
    "Подключить пульсометр": "Connect heart-rate monitor",
    "Отключить пульсометр": "Disconnect heart-rate monitor",
    "подключите совместимый пульсометр": "connect a compatible heart-rate monitor",
    "Активность и маршрут": "Activity and route",
    ...
    "Для надёжных напоминаний при закрытом приложении": "For reliable reminders when the app is closed",
    ...
    "3D-просмотр": "3D preview", "Вернуть маршрут": "Show route", "Города офлайн": "Offline cities", "Карты городов": "City maps",
    ...
    "Тон сообщения": "Message tone",
    "Аудит жизни": "Life audit", "Тон вердикта": "Verdict tone", "Поддерживающий": "Supportive", "Жёсткий": "Hard",
    "Слишком жёстко — сделай мягче": "Too harsh — make it softer",
    "Пока маловато завершённых дел за неделю для честного вердикта — отмечайте выполненное, вернусь с разбором позже.":
      "Not enough completed tasks this week yet for an honest verdict — mark things done, I'll come back with a breakdown later.",
    "Как отказаться": "How to say no",
    "ИИ сочинит черновик вежливого отказа или переноса. Это только текст для вас — приложение никому не звонит и ничего не отправляет само.":
      "The AI drafts a polite decline or reschedule for you. This is text for you only — the app never calls or sends anything on its own.",
    "Например: не хочу идти на встречу с боссом в 15:00, хочу перенести на завтра": "For example: don't want to go to the meeting with my boss at 3pm, want to reschedule for tomorrow",
    "Кому адресовано (необязательно)": "Addressed to (optional)",
    "Вежливый": "Polite", "Уверенный": "Firm", "С юмором": "Humorous",
    "Сочинить черновик": "Draft it", "Прослушать черновик": "Listen to draft", "Скопировать текст": "Copy text",
    "Купить разово — 99 ₽": "Buy one-time — 99 ₽",
    "Emergency Exit": "Emergency Exit",
    "Переносит все несделанные необязательные и важные-но-не-срочные дела на завтра одним нажатием. Срочные и уже начатые дела остаются на сегодня.": "Moves all undone optional and important-but-not-urgent tasks to tomorrow with one tap. Urgent and already started tasks stay today.",
    "Выйти из дня": "Exit the day",
    "Купить разово — 499 ₽": "Buy one-time — 499 ₽",
    "Это черновик от ИИ, не отправленное сообщение. Прочитайте и решите сами, отправлять ли его и в каком виде.":
      "This is an AI draft, not a sent message. Read it and decide for yourself whether and how to send it.",
    ...
    "Связать вопрос с делом": "Link question to a task", "Задайте любой вопрос или выберите дело выше, чтобы получить ответ с контекстом": "Ask any question or select a task above for an answer with context",
    "Загрузка города": "City download", "Закрыть": "Close", "Название города": "City name"
  },

  /* ===== Шаблоны с числами ===== */
  re: [
    ["^Завершено: (\\d+) дел$", "Completed: $1 tasks"],
    ["^Приоритеты: (\\d+) из 4 зон закрыты$", "Priorities: $1 of 4 areas covered"],
    ["^Лучший день: (\\d+) дел$", "Best day: $1 tasks"],
    ["^тариф (.+)$", "plan $1"],
    ["^Тариф: (.+)$", "Plan: $1"],
