...
window.__i18nDict("en", {
  ...
  t: {
    ...
    "Выйти": "Sign out",
    "Условия оплаты и возврата": "Payment and refund terms",
    "Загружаем аккаунт и актуальные тарифы…": "Loading your account and current plans…",
    "Оплата картой или через СБП. Данные карты вводятся только на защищённой странице PlateGA.": "Pay by card or instant bank transfer. Card details are entered only on PlateGA's secure page.",
    "Тарифы загружены, но касса ещё не принимает платежи.": "Plans are available, but checkout is not accepting payments yet.",
    "Базовый доступ без оплаты": "Basic access at no charge",
    "Текущий тариф": "Current plan",
    "Бесплатный": "Free",
    "Оплата временно недоступна": "Payment temporarily unavailable",
    "навсегда": "forever",
    "за 30 дней": "for 30 days",
    "30 дней": "30 days",
    "без автопродления": "no auto-renewal",
    "Оплата подтверждена, тариф обновлён.": "Payment confirmed. Your plan has been updated.",
    "Платёж ещё обрабатывается. Повторите проверку через несколько секунд.": "The payment is still processing. Check again in a few seconds.",
    "Оплата отменена. Тариф не изменён, повторить можно в любой момент.": "Payment cancelled. Your plan was not changed; you can try again at any time.",
    "Документы": "Documents",
    "Поддержка": "Support",
    "Цвет": "Theme",
    "Голос ответа:": "Response voice:",
    "Голос ответа": "Response voice",
    "Джейн — спокойный, деловой": "Jane — calm, professional",
    "Оксана — мягкий, уверенный": "Oksana — warm, confident",
    "Алёна — ясный, энергичный": "Alena — clear, energetic",
    "Филипп — низкий, деловой": "Filipp — deep, professional",
    "— голос хранится на этом устройстве": "— voice is saved on this device",
    "Включить зелёную тему с золотыми буквами": "Enable the emerald theme with gold lettering",
    ...
    "Дело или адрес": "Task or address",
    ...
    "Маршрут к делам": "Route to tasks",
    "Следующая остановка": "Next stop",
    "Начать маршрут": "Start route",
    "Очистить маршрут": "Clear route",
    "Маршрут убран с карты. Дела и история сохранены.": "Route cleared from the map. Tasks and history are saved.",
    "Показать остановку на карте": "Show stop on map",
    "Навигация SUPER DAY": "SUPER DAY navigation",
    "Маршрут активен": "Route active",
    "Маршрут приостановлен": "Route paused",
    "Ждём геолокацию": "Waiting for location",
    "Разрешите геолокацию, чтобы начать движение.": "Allow location access to start moving.",
    "Маршрут недоступен": "Route unavailable",
    "Строим по дорогам": "Building road route",
    "Получаем маршрут от сервера…": "Getting the route from the server…",
    "осталось": "remaining",
    "Топливо и стоимость": "Fuel and cost",
    "GPS отслеживает позицию": "GPS is tracking your position",
    "Ожидаем новое положение GPS": "Waiting for a new GPS position",
    "Завершить маршрут": "End route",
    "К моей позиции": "My location",
    "Нужна геолокация": "Location needed",
    "Геолокация нужна для движения по маршруту": "Location access is needed to follow the route",
    "Сигнал GPS потерян. Разрешите геолокацию и повторите попытку.": "GPS signal lost. Allow location access and try again.",
    "Слежение за маршрутом…": "Tracking the route…",
    "Маршрут остаётся внутри SUPER DAY. Позиция обновляется по GPS.": "The route stays inside SUPER DAY. Your position updates via GPS.",
    "прибытие": "arrival",
    "Открыть дело": "Open task",
    "Открыть навигацию": "Open navigation",
    "Открыть адрес в навигаторе": "Open address in navigation",
    "Разрешить геолокацию": "Allow location access",
    "Определяем позицию…": "Finding your location…",
    "Указать расход авто": "Set fuel consumption",
    "Указать цену топлива": "Set fuel price",
    "Определяем текущую геопозицию для старта маршрута…": "Finding your current location to start the route…",
    "Адрес найден. Время в пути появится сразу после определения старта.": "Address found. Travel time will appear as soon as the start is located.",
    "Старт маршрута не определён": "Route start is not set",
    "Адрес найден. Для времени, километража и топлива нужен доступ к текущей геопозиции.": "Address found. Current location access is needed for travel time, distance and fuel.",
    "Старт: текущая геопозиция": "Start: current location",
    "Строим маршрут по дорогам…": "Building the road route…",
    "Маршрут временно недоступен. Проверьте соединение и повторите расчёт.": "The route is temporarily unavailable. Check your connection and try again.",
    "расстояние": "distance",
    "в пути": "travel time",
    "топливо": "fuel",
    "стоимость": "cost",
    "Укажите реальный расход автомобиля, чтобы посчитать топливо.": "Enter your actual vehicle consumption to calculate fuel.",
    "Укажите цену топлива, чтобы увидеть стоимость поездки.": "Enter the fuel price to see the trip cost.",
    "Маршрут построен по дорожной сети.": "Route built using the road network.",
    "Учтена дорожная обстановка: без пробок.": "Traffic included: clear roads.",
    "Учтена дорожная обстановка: пробки заметные.": "Traffic included: moderate congestion.",
    "Учтена дорожная обстановка: пробки плотные.": "Traffic included: heavy congestion.",
    "Сегодня": "Today",
  ...
  re: [
    ["^тариф (.+)$", "plan $1"],
    ["^Тариф: (.+)$", "Plan: $1"],
    ["^(\\d+) AI-разбор(?:ов|а)? в день$", "$1 AI analyses per day"],
    ["^Оплатить (.+)$", "Pay $1"],
    ["^Маршрут дня · (\\d+) остановки$", "Day route · $1 stops"],
