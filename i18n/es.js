...
window.__i18nDict("es", {
  ...
  t: {
    "Рабочий ритм": "Ritmo de trabajo",
    "Рабочий ритм и аналитика": "Ritmo de trabajo y analitica",
    "за всё время": "en total",
    "нет завершений": "sin tareas completadas",
    "Движение сегодня": "Movimiento de hoy",
    "Движение": "Actividad",
    "Открыть шагомер, пульс и местоположение": "Abrir podómetro, pulso y ubicación",
    "Скрыть шагомер, пульс и местоположение": "Ocultar podómetro, pulso y ubicación",
    "Готово к прогулке": "Listo para caminar",
    ...
    "Шагомер остановлен": "Contador de pasos detenido",
    "Шагомер недоступен на этом устройстве": "El contador de pasos no esta disponible en este dispositivo",
    "Датчик движения не разрешён": "No se concedio permiso para el sensor de movimiento",
    "Не удалось включить датчик движения": "No se pudo activar el sensor de movimiento",
    "Карты городов": "Mapas de ciudades",
    "Пульс: нет данных": "Pulso: sin datos",
    "Подключить пульсометр": "Conectar pulsometro",
    "Отключить пульсометр": "Desconectar pulsometro",
    "подключите совместимый пульсометр": "conecta un pulsometro compatible",
    "Активность и маршрут": "Actividad y ruta",
    ...
    "3D-просмотр": "Vista 3D", "Вернуть маршрут": "Mostrar ruta", "Города офлайн": "Ciudades sin conexión", "Карты городов": "Mapas de ciudades",
  ...
  re: [
    ["^Завершено: (\\d+) дел$", "Completadas: $1 tareas"],
    ["^Приоритеты: (\\d+) из 4 зон закрыты$", "Prioridades: $1 de 4 areas cubiertas"],
    ["^Лучший день: (\\d+) дел$", "Mejor dia: $1 tareas"],
    ["^тариф (.+)$", "plan $1"],
    ["^Тариф: (.+)$", "Plan: $1"],
