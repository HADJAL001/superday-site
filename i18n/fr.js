...
window.__i18nDict("fr", {
  ...
  t: {
    "Рабочий ритм": "Rythme de travail",
    "Рабочий ритм и аналитика": "Rythme de travail et analyse",
    "за всё время": "depuis le debut",
    "нет завершений": "aucune tache terminee",
    "Движение сегодня": "Mouvement aujourd'hui",
    "Движение": "Activité",
    "Открыть шагомер, пульс и местоположение": "Ouvrir le podomètre, le pouls et la position",
    "Скрыть шагомер, пульс и местоположение": "Masquer le podomètre, le pouls et la position",
    "Готово к прогулке": "Pret pour la marche",
    "из 8 000 шагов": "sur 8 000 pas",
    "Определить моё местоположение": "Trouver ma position",
    "В путь": "Demarrer l'itineraire",
    "Показать шагомер и пульс": "Afficher le compteur de pas et la frequence cardiaque",
    "Скрыть шагомер и пульс": "Masquer le compteur de pas et la frequence cardiaque",
    "Включить шагомер": "Activer le compteur de pas",
    "Остановить шагомер": "Arreter le compteur de pas",
    "Шагомер включён": "Compteur de pas active",
    "Шагомер остановлен": "Compteur de pas arrete",
    "Шагомер недоступен на этом устройстве": "Le compteur de pas est indisponible sur cet appareil",
    "Датчик движения не разрешён": "Autorisation du capteur de mouvement non accordee",
    "Не удалось включить датчик движения": "Impossible d'activer le capteur de mouvement",
    "Карты городов": "Cartes des villes",
    "Пульс: нет данных": "Pouls : aucune donnee",
    "Подключить пульсометр": "Connecter le cardiofrequencemetre",
    "Отключить пульсометр": "Deconnecter le cardiofrequencemetre",
    "подключите совместимый пульсометр": "connectez un cardiofrequencemetre compatible",
    "Активность и маршрут": "Activite et itineraire",
    "Аккаунт и тариф": "Compte et formule",
    "войти": "se connecter",
    "Войдите или создайте аккаунт, чтобы выбрать тариф.": "Connectez-vous ou créez un compte pour choisir une formule.",
    "Пароль": "Mot de passe",
    "Войти": "Se connecter",
    "Создать аккаунт": "Créer un compte",
    "Выйти": "Se déconnecter",
    "Условия оплаты и возврата": "Conditions de paiement et de remboursement",
    "Загружаем аккаунт и актуальные тарифы…": "Chargement du compte et des formules actuelles…",
    "Оплата картой или через СБП. Данные карты вводятся только на защищённой странице PlateGA.": "Paiement par carte ou virement instantané. Les données de carte ne sont saisies que sur la page sécurisée de PlateGA.",
    "Тарифы загружены, но касса ещё не принимает платежи.": "Les formules sont disponibles, mais le paiement n'accepte pas encore de transactions.",
    "Базовый доступ без оплаты": "Accès de base sans paiement",
    "Текущий тариф": "Formule actuelle",
    "Бесплатный": "Gratuit",
    "Оплата временно недоступна": "Paiement temporairement indisponible",
    "навсегда": "sans limite",
    "за 30 дней": "pour 30 jours",
    "30 дней": "30 jours",
    "без автопродления": "sans renouvellement automatique",
    "Оплата подтверждена, тариф обновлён.": "Paiement confirmé. Votre formule a été mise à jour.",
    "Платёж ещё обрабатывается. Повторите проверку через несколько секунд.": "Le paiement est encore en cours. Vérifiez à nouveau dans quelques secondes.",
    "Оплата отменена. Тариф не изменён, повторить можно в любой момент.": "Paiement annulé. Votre formule n'a pas changé ; vous pouvez réessayer à tout moment.",
    "Документы": "Documents",
    "Поддержка": "Assistance",
    "Цвет": "Thème",
    "Голос ответа:": "Voix de réponse :",
    "Голос ответа": "Voix de réponse",
    "Джейн — спокойный, деловой": "Jane — calme et professionnelle",
    "Оксана — мягкий, уверенный": "Oksana — chaleureuse et sûre",
    "Алёна — ясный, энергичный": "Alena — claire et énergique",
    "Филипп — низкий, деловой": "Filipp — grave et professionnel",
    "— голос хранится на этом устройстве": "— la voix est enregistrée sur cet appareil",
    "Включить зелёную тему с золотыми буквами": "Activer le thème émeraude aux lettres dorées",
    ...
    "Дело или адрес": "Tâche ou adresse",
    ...
    "Маршрут приостановлен": "Itinéraire en pause",
    "Ждём геолокацию": "En attente de la position",
    "Разрешите геолокацию, чтобы начать движение.": "Autorisez la géolocalisation pour démarrer.",
    "Маршрут недоступен": "Itinéraire indisponible",
    "Строим по дорогам": "Calcul de l’itinéraire routier",
    "Получаем маршрут от сервера…": "Récupération de l’itinéraire depuis le serveur…",
    "осталось": "restant",
    "Топливо и стоимость": "Carburant et coût",
    "GPS отслеживает позицию": "Le GPS suit votre position",
    "Ожидаем новое положение GPS": "En attente d’une nouvelle position GPS",
    "Завершить маршрут": "Terminer l’itinéraire",
    "К моей позиции": "Ma position",
    "Нужна геолокация": "Position requise",
    "Геолокация нужна для движения по маршруту": "La géolocalisation est nécessaire pour suivre l’itinéraire",
    "Сигнал GPS потерян. Разрешите геолокацию и повторите попытку.": "Signal GPS perdu. Autorisez la géolocalisation et réessayez.",
    "Слежение за маршрутом…": "Suivi de l’itinéraire…",
    "Маршрут остаётся внутри SUPER DAY. Позиция обновляется по GPS.": "L’itinéraire reste dans SUPER DAY. Votre position est actualisée par GPS.",
    "прибытие": "arrivée",
    "Открыть дело": "Ouvrir la tâche",
    "Открыть навигацию": "Ouvrir la navigation",
    "Открыть адрес в навигаторе": "Ouvrir l’adresse dans la navigation",
    "Разрешить геолокацию": "Autoriser la géolocalisation",
    "Определяем позицию…": "Localisation en cours…",
    "Указать расход авто": "Indiquer la consommation",
    "Указать цену топлива": "Indiquer le prix du carburant",
    "Определяем текущую геопозицию для старта маршрута…": "Recherche de votre position pour démarrer l’itinéraire…",
    "Адрес найден. Время в пути появится сразу после определения старта.": "Adresse trouvée. Le temps de trajet apparaîtra dès que le départ sera localisé.",
    "Старт маршрута не определён": "Départ de l’itinéraire non défini",
    "Адрес найден. Для времени, километража и топлива нужен доступ к текущей геопозиции.": "Adresse trouvée. La position actuelle est nécessaire pour le temps, la distance et le carburant.",
    "Старт: текущая геопозиция": "Départ : position actuelle",
    "Строим маршрут по дорогам…": "Calcul de l’itinéraire routier…",
    "Маршрут временно недоступен. Проверьте соединение и повторите расчёт.": "L’itinéraire est temporairement indisponible. Vérifiez la connexion et réessayez.",
    "расстояние": "distance",
    "в пути": "temps de trajet",
    "топливо": "carburant",
    "стоимость": "coût",
    "Укажите реальный расход автомобиля, чтобы посчитать топливо.": "Indiquez la consommation réelle du véhicule pour calculer le carburant.",
    "Укажите цену топлива, чтобы увидеть стоимость поездки.": "Indiquez le prix du carburant pour connaître le coût du trajet.",
    "Маршрут построен по дорожной сети.": "Itinéraire calculé sur le réseau routier.",
    "Учтена дорожная обстановка: без пробок.": "Trafic pris en compte : routes dégagées.",
    "Учтена дорожная обстановка: пробки заметные.": "Trafic pris en compte : circulation modérée.",
    "Учтена дорожная обстановка: пробки плотные.": "Trafic pris en compte : circulation dense.",
    "Сегодня": "Aujourd'hui",
    ...
    "3D-просмотр": "Aperçu 3D", "Вернуть маршрут": "Afficher l'itinéraire", "Города офлайн": "Villes hors ligne", "Карты городов": "Cartes des villes",
    ...
    "Связать вопрос с делом": "Lier la question à une tâche", "Задайте любой вопрос или выберите дело выше, чтобы получить ответ с контекстом": "Posez toute question ou choisissez une tache pour une reponse avec contexte",
    "Загрузка города": "Téléchargement de ville", "Закрыть": "Fermer", "Название города": "Nom de la ville"
    ,"Начать день": "Commencer la journée",
    "Когда наступит время дела — приложение подскажет уведомлением и голосом. Для надёжных напоминаний при закрытом приложении": "Quand l'heure de la tâche arrive, l'app prévient par une notification et par la voix. Pour des rappels fiables lorsque l'app est fermée",
    ": события лягут в системный календарь с будильниками. Web Push доступен после входа и разрешения в браузере; расписание дел пока хранится только на этом устройстве.": ": les événements seront ajoutés au calendrier système avec des alarmes. Web Push est disponible après la connexion et l'autorisation du navigateur ; le planning reste pour l'instant sur cet appareil.",
    ": события лягут в системный календарь с будильниками. Web Push подключается после входа и разрешения браузера; расписание дел пока хранится только на этом устройстве.": ": les événements seront ajoutés au calendrier système avec des alarmes. Web Push est disponible après la connexion et l'autorisation du navigateur ; le planning reste pour l'instant sur cet appareil.",
    "Аудит жизни": "Bilan de la semaine", "Пока маловато завершённых дел за неделю для честного вердикта — отмечайте выполненное, вернусь с разбором позже.": "Il y a encore trop peu de tâches terminées cette semaine pour un bilan honnête. Marquez ce qui est fait et je reviendrai avec une analyse plus tard.",
    "Тон вердикта": "Ton du bilan", "Поддерживающий": "Bienveillant", "Жёсткий": "Direct", "Слишком жёстко — сделай мягче": "Trop direct : adoucir",
    "Переносит все несделанные необязательные и важные-но-не-срочные дела на завтра одним нажатием. Срочные и уже начатые дела остаются на сегодня.": "Reporte à demain d'un geste toutes les tâches facultatives et importantes mais non urgentes qui ne sont pas faites. Les tâches urgentes et déjà commencées restent aujourd'hui.",
    "Выйти из дня": "Clore la journée", "Купить разово — 499 ₽": "Acheter une fois — 499 ₽", "Как отказаться": "Comment refuser",
    "ИИ сочинит черновик вежливого отказа или переноса. Это только текст для вас — приложение никому не звонит и ничего не отправляет само.": "L'IA rédigera un brouillon pour refuser ou reporter poliment. C'est seulement du texte pour vous : l'app n'appelle ni n'envoie rien toute seule.",
    "Вежливый": "Poli", "Уверенный": "Assuré", "С юмором": "Avec humour", "Сочинить черновик": "Créer un brouillon", "Купить разово — 99 ₽": "Acheter une fois — 99 ₽",
    "Прослушать черновик": "Écouter le brouillon", "Скопировать текст": "Copier le texte", "Это черновик от ИИ, не отправленное сообщение. Прочитайте и решите сами, отправлять ли его и в каком виде.": "C'est un brouillon d'IA, pas un message envoyé. Lisez-le et décidez vous-même de l'envoyer ou non, et sous quelle forme.",
    "Например: не хочу идти на встречу с боссом в 15:00, хочу перенести на завтра": "Par exemple : je ne veux pas aller à la réunion avec mon chef à 15 h, je veux la reporter à demain",
    "Кому адресовано (необязательно)": "Destinataire (facultatif)", "Тон сообщения": "Ton du message"
  },

  re: [
    ["^Завершено: (\\d+) дел$", "Terminees : $1 taches"],
    ["^Приоритеты: (\\d+) из 4 зон закрыты$", "Priorites : $1 zones sur 4 couvertes"],
    ["^Лучший день: (\\d+) дел$", "Meilleure journee : $1 taches"],
    ["^тариф (.+)$", "formule $1"],
    ["^Тариф: (.+)$", "Formule : $1"],
    ["^(\\d+) AI-разбор(?:ов|а)? в день$", "$1 analyses IA par jour"],
    ["^Оплатить (.+)$", "Payer $1"],
    ["^Маршрут дня · (\\d+) остановки$", "Parcours du jour · $1 arrêts"],
